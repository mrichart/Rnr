...
upstream_check_sleep=5 --delay for attamepting a reconnect upstream
sockets_timeout=60*60*24 + math.random(-1, 1) --time with no traffic on a socket before closing&reconecting
subscription_dupe_window_size=60 --max time to keep subscription_ids for dupe detection
subscription_dupe_window_amount=1000 --max amount of subscription_ids kept for dupe detection
notification_dupe_window_size=60 --max time to keep notification_ids for dupe detection
notification_dupe_window_amount=1000 --max amount of notification_ids kept for dupe detection

newscast_round_time=math.huge
